...
export const Sidebar = ({ onAllClick, onTrendingClick, activeView }: SidebarProps) => {
  return (
    <aside className="w-64 bg-gray-900 border-r border-gold-900/30 min-h-[calc(100vh-73px)] sticky top-[73px]">
      <div className="p-4 space-y-1">
        <button
          onClick={onAllClick}
          className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg transition-all text-sm ${
            activeView === 'all'
              ? 'text-gold-400 bg-gold-950/50 shadow-lg shadow-gold-900/20 border border-gold-800/30'
