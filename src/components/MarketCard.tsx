  ...
  return (
    <>
      <div
        ...
        className="bg-gray-900 border border-gold-900/30 rounded-lg p-5 hover:border-gold-700/50 hover:shadow-lg hover:shadow-gold-900/20 transition-all duration-300 cursor-pointer group transform hover:-translate-y-0.5"
      >
        <div className="flex items-start gap-4">
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex items-center gap-2">
                <div className="bg-gradient-to-br from-gold-800/40 to-gold-900/40 p-2 rounded-lg shrink-0 border border-gold-800/30">
                  {getCryptoIcon(market.icon)}
                </div>
                <h3 className="text-white font-medium text-[13px] leading-tight group-hover:text-gold-200 transition-colors">
                  {market.question}
                </h3>
              </div>
              {getOutcomeBadge()}
            ...
            <div className="flex items-center gap-4 mb-3">
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1.5">
                  <div className="w-2 h-2 bg-gold-500 rounded-full shadow-lg shadow-gold-500/50"></div>
                  <span className="text-gold-400 font-medium text-xs">{yesPercent}%</span>
                </div>
                <div className="flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-1.5 text-gray-500 text-xs">
                ...
                <span>{formatVolume(market.total_volume)} GOLD</span>
              </div>
              ...
              <div className="flex items-center gap-1.5 text-gray-500 text-xs">
                ...
                <span className="text-gold-400">↑{formatVolume(market.yes_volume)}</span>
              </div>
            ...
            <div className="mt-2 h-1 bg-gray-800 rounded-full overflow-hidden">
              <div className="flex h-full">
                <div
                  className="bg-gradient-to-r from-gold-500 to-gold-600 transition-all shadow-lg"
